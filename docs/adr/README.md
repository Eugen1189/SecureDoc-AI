...
This directory contains records of the architectural decisions made for the **SecureDoc-AI** project.

## List of ADRs

| ID | Title | Status | Date |
|----|-------|--------|------|
| [ADR-001](001-vector-database-selection.md) | Vector Database Selection | Accepted | 2026-03-04 |
